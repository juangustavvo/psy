...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/juangustavvo/psy/main/addon/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/juangustavvo/psy/main/add/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/juangustavvo/psy/main/del/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/juangustavvo/psy/main/cek/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/juangustavvo/psy/main/renew/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
