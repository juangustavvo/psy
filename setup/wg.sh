...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/juangustavvo/psy/main/add/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/juangustavvo/psy/main/del/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/juangustavvo/psy/main/renew/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
