...
wget -q -O /usr/local/bin/websocket https://raw.githubusercontent.com/juangustavvo/psy/main/websocket/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://raw.githubusercontent.com/juangustavvo/psy/main/websocket/ws-ovpn.py
